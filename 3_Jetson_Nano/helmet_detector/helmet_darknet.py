...
def performDetect(imagePath="media/helmet_test.jpg", thresh= 0.25, configPath = "./configs/yolov4-helmet-detection.cfg", weightPath = "./configs/yolov4-helmet-detection.weights", metaPath= "./configs/yolov4-helmet-detection.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
...
def performBatchDetect(thresh= 0.25, configPath = "./configs/yolov4-helmet-detection.cfg", weightPath = "./configs/yolov4-helmet-detection.weights", metaPath= "./configs/yolov4-helmet-detection.data", hier_thresh=.5, nms=.45, batch_size=3):
    import cv2
    import numpy as np
